...
def load_data(messages_filepath, categories_filepath):
    '''Loads the datasets and merge them together
       ...
       Return:
             df(dataframe of merged datasets)
...
def clean_data(df):
    ''' Cleans the dataset:
                          -Removing duplucates
                          -Expanding categories columns 
                          -Setting Column names
                          -Setting Column values
     Args:
          df(Dataframe of combined dataset)
    ...
    #the related column should be binary, replace 2's with 1's
